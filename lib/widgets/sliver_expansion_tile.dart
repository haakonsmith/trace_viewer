...
class _InheritedSliverExpansionTile extends InheritedModel<String> {
  ...
  static SliverExpansionTileController of(BuildContext context, String section) {
    return InheritedModel.inheritFrom<_InheritedSliverExpansionTile>(context, aspect: section)!.controller;
  }
  ...
  @override
  bool updateShouldNotifyDependent(covariant _InheritedSliverExpansionTile oldWidget, Set<String> dependencies) {
...
class _SliverExpansionTileContentState extends State<SliverExpansionTileContent> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return _SliverExpansionTileContent(
      ...
      sliver: contentVisible ? widget.sliverBuilder(context) : const SizedBox(),
    );
  }
}
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (geometry!.maxPaintExtent < childGeometry.maxPaintExtent) {
      ...
      if (constraints.axis == Axis.vertical) {
        rect = Offset(0.0, geometry!.paintOrigin) & Size(constraints.crossAxisExtent, geometry!.paintExtent);
      } else {
        rect = Offset(geometry!.paintOrigin, 0.0) & Size(geometry!.paintExtent, constraints.crossAxisExtent);
      }
